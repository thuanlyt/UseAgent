# ReleaseWitness project instructions
...
Khi người dùng chỉ cung cấp goal và roster, dùng `$relwit` làm front door. Supervisor ghi project brief, chọn/ghi rõ stack assumption, tạo DAG, dispatch mailbox và theo dõi cho đến production gate.
...
2. Mọi thay đổi phải thuộc một work item có `id`, acceptance criteria, scope và owner. Dùng `relwit` để tạo/dispatch/claim/report/cập nhật thay vì sửa registry bằng tay.
